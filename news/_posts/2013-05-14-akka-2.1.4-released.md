...
***2.1.3 Release was corrupted*** because of a bug in the release scripts and build process. Please do not use 2.1.3 but use this release instead. Concerning any Akka code related changes the two releases are completely identical, the only changes in 2.1.4 are removed artifacts leaking in from a different version that affected 2.1.3.
