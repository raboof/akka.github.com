...
Especially the second and third point mean that porting code from Streams & HTTP 2.0 to Akka 2.4.2 will require some mechanical source code changes, please refer to the migration guide(for [Java](https://doc.akka.io/docs/akka/2.4/java/stream/migration-guide-2.0-2.4-java.html) and [Scala](https://doc.akka.io/docs/akka/2.4/scala/stream/migration-guide-2.0-2.4-scala.html)) for the details.
...
* added Java patterns for CompletionStage, see [PatternsCS](https://doc.akka.io/japi/akka/2.4/akka/pattern/PatternsCS.html)
