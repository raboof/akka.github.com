...
* experimental stream based API for the [Query Side](https://doc.akka.io/docs/akka/2.4-M3/scala/persistence-query.html) of Akka Persistence (implementations must be provided by query plugins corresponding to the journal plugins for the various data stores)
* Akka Persistence [event adapters](https://doc.akka.io/docs/akka/2.4-M3/scala/persistence.html#event-adapters) to support separation between domain events and storage representation (not necessarily as bytes)
* comprehensive documentation of strategies for [schema evolution](https://doc.akka.io/docs/akka/2.4-M3/scala/persistence-schema-evolution.html) of persistent events
* Activator template for Distributed Data in both [Java](https://doc.akka.io/docs/akka/2.4-M3/java/distributed-data.html#Samples) and [Scala](https://doc.akka.io/docs/akka/2.4-M3/scala/distributed-data.html#Samples)
...
We will most likely not be able to complete the Java API and the documentation for [Akka Typed](https://doc.akka.io/docs/akka/2.4-M3/scala/typed.html) for 2.4.0, but the Scala API will be released in order to gather early feedback on this rather exciting new module.
