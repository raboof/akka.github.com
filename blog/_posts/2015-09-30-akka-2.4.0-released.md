...
* dropped support for Java 6 & 7 as announced in the [last roadmap update](https://www.lightbend.com/blog/akka-roadmap-update-dec-2014), and now require Java 8 or later—this will allow us to create modern idiomatic Java APIs over the course of the upcoming releases
...
* [ClusterClient](https://doc.akka.io/docs/akka/2.4/scala/cluster-client.html) now uses custom failure detection to avoid quarantining in case of transient network failures
...
The Java API and the documentation for [Akka Typed](https://doc.akka.io/docs/akka/2.4/scala/typed.html) will be added. The Scala API was released in 2.4.0 in order to gather early feedback on this rather exciting new module.
