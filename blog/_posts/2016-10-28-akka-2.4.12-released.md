...
Akka HTTP is *not* part of this release as it [has moved to it’s own repository](https://github.com/akka/akka-http) and will be released very soon under it’s own version number.
