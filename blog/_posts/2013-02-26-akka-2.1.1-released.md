...
When migrating an existing project from Akka 2.0.x please have a look at our [migration guide from 2.0 to 2.1](https://doc.akka.io/docs/akka/2.1.0/project/migration-guide-2.0.x-2.1.x.html)
