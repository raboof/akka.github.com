...
With its wide span of different technologies, Alpakka depends on contributors with deep knowledge and experience in those. Lightbend's Alpakka team focuses on sheperding all the efforts contributors make to improve Alpakka.
...
* Alpakka CSV
* Alpakka Couchbase 
* Alpakka Kafka (support has been available)
