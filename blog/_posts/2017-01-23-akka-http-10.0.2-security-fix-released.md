...
and Lari Hotari whom we'd like to thank for their thorough investigation and following our [security process](https://doc.akka.io/docs/akka-http/10.0.2/security.html#reporting-vulnerabilities).
...
Further details are explained in the Akka documentation's [security announcements section](https://doc.akka.io/docs/akka-http/10.0.2/security/2017-01-23-denial-of-service-via-leak-on-unconsumed-closed-connections.html).
